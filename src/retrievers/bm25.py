...
class BM25(Retriever):
    ...
    Attributes:
        ...
        dataset (Any): The knowledge base.
        
    """
    def __init__(self, name: str = 'bm25', top_k: int = 25, use_unidecode: bool = True, dataset=None, **kwargs: Any):
    ...
    def retrieve(self, query: str) -> tuple:
        ...
        top_k_texts = [
            self.dataset.get_document(fc_id)
            for fc_id in top_k
        ]
